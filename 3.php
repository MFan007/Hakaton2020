...
<div id="bigdiv">
    <div class="fixed-size-container">
        <div class="sidebar"><p>Samsung Galaxy S10e</p>
            <img src="images/content3.jpg" alt="Samsung Galaxy S10e" width="160" height="212">
        </div>
        <div id="specs-list">
            <table cellspacing="0">
                <tr class="tr-hover">
            ...
            <table cellspacing="0">
                <tr>
                    ...
                    <td class="nfo">142.2 x 69.9 x 7.9 mm (5.60 x 2.75 x 0.31 in)</td>
                </tr><tr>
            ...
            <table cellspacing="0">
                ...
                <tr>
                    ...
                    <td class="nfo">5.8 inches, 82.8 cm<sup>2</sup> (~88.3% screen-to-body ratio)</td>
                </tr>
                <tr>
            ...
            <table cellspacing="0">
                ...
                <tr>
                    <td class="ttl">SAR</td>
                    <td class="nfo">0.56 W/kg (head) &nbsp; &nbsp; 0.70 W/kg (body) &nbsp; &nbsp; </td>
                </tr>
                <tr>
                    <td class="ttl">SAR EU</td>
                    <td class="nfo">0.58 W/kg (head) &nbsp; &nbsp; 1.57 W/kg (body) &nbsp; &nbsp; </td>
                </tr>
                <tr>
                    <td class="ttl">Price</td>
                    <td class="nfo">&#36;&thinsp;409.89 / &#8364;&thinsp;492.00 / &#163;&thinsp;460.00 / &#8377;&thinsp;36.999</td>
                </tr>
            </table>
            ...
            <table cellspacing="0">
                <tr>
                    ...
                    <td class="nfo">
                        <a class="noUnd">Basemark OS II: 4286 / Basemark OS II 2.0: 4470<br>Basemark X: 44070</td>
                </tr><tr>

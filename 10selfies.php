...
<p class="title">TOP 10 PHONES FOR SELFIES</p>
<div id="bigdiv">
    ...
    <div class="fixed-size-container">
        <a href="7.php"><img src="images/content7.jpg" alt="Samsung Galaxy Note10+"></a>
        <a href="7.php"><div class="text-block">
                <h2>Samsung Galaxy Note10+</h2>
            </div></a>
    </div>
    <div class="fixed-size-container">
    ...
    <div class="fixed-size-container">
        <a href="15.php"><img src="images/content15.jpg" alt="Apple iPhone 11 Pro"></a>
        <a href="15.php"><div class="text-block">

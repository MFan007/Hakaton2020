...
if(isset($_SESSION['userId'])) {
    ...
    <div id="bigdiv">
        <div class="fixed-size-container">
            <div class="sidebar"><p>Huawei P30 Pro</p>
                <img src="images/content27.jpg" alt="Huawei P30 Pro" width="160" height="212">
            </div>
            <div id="specs-list">
                <table cellspacing="0">
                    <tr class="tr-hover">
                ...
                <table cellspacing="0">
                    <tr>
                        ...
                        <td class="nfo">162.3 x 77.2 x 7.9 mm (6.39 x 3.04 x 0.31 in)</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="nfo">Glass front (Gorilla Glass 6), glass back (Gorilla Glass 6), aluminum frame</td>
                    </tr>
                    <tr>
                        <td class="ttl">SIM</td>
                ...
                <table cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td class="nfo">6.3 inches, 98.6 cm<sup>2</sup> (~90.9% screen-to-body ratio)</td>
                    </tr>
                    <tr>
                        <td class="ttl">Resolution</td>
                        <td class="nfo">1080 x 2280 pixels, 19:9 ratio (~401 ppi density)</td>
                    </tr>
                    <tr>
                ...
                <table cellspacing="0">
                    <tr>
                        ...
                        <td class="nfo">Aura Glow, Aura White, Aura Black, Aura Blue</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="ttl">SAR</td>
                        <td class="nfo">0.85 W/kg (head) &nbsp; &nbsp; 1.08 W/kg (body) &nbsp; &nbsp;</td>
                    </tr>
                    <tr>
                        <td class="ttl">SAR EU</td>
                        <td class="nfo">0.21 W/kg (head) &nbsp; &nbsp; 1.52 W/kg (body) &nbsp; &nbsp;</td>
                    </tr>
                    <tr>
                        <td class="ttl">Price</td>
                        <td class="nfo">&#36;&thinsp;659.63 / &#8364;&thinsp;891.25 / &#163;&thinsp;688.16 / &#8377;&thinsp;69.999</td>
                    </tr>
                </table>
                ...
                <table cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td class="nfo">Endurance rating 107h</td>
                    </tr>
                    <tr>
                    </tr>
                </table>

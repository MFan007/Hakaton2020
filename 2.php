...
<div id="bigdiv">
    <div class="fixed-size-container">
        <div class="sidebar"><p>Samsung Galaxy S10+</p>
            <img src="images/content2.jpg" alt="Samsung Galaxy S10+" width="160" height="212">
        </div>
        <div id="specs-list">
            <table cellspacing="0">
                <tr class="tr-hover">
            ...
            <table cellspacing="0">
                <tr>
                    ...
                    <td class="nfo">Prism White, Prism Black, Prism Green, Prism Blue, Canary Yellow, Flamingo Pink, Ceramic Black, Ceramic White, Cardinal Red, Smoke Blue</td>
                </tr>
                <tr>
